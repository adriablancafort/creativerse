...
import { createImageGenerationRequestSchema } from "@workspace/shared/api/image/schemas"
import type { CreateImageGenerationRequest } from "@workspace/shared/api/image/types"
import {
  DropdownMenu,
  DropdownMenuContent,
...
import { ModelPicker } from "@/components/image/model-picker"
...
type ImageComposerProps = {
  ...
  onSubmit: (values: CreateImageGenerationRequest) => Promise<unknown>
}
...
export function ImageComposer({
  ...
  const canCreate = useCheckPermission({ image: ["create"] })
  const form = useForm<CreateImageGenerationRequest>({
    resolver: zodResolver(createImageGenerationRequestSchema),
    defaultValues: {
      prompt: "",
  ...
  async function submit(values: CreateImageGenerationRequest) {
