...
export const createImageTurnRequestSchema = z
  .object({
    prompt: promptSchema,
...
export const createImageSessionRequestSchema = createImageTurnRequestSchema

export const createImageSessionIdParamsSchema = z.object({
